...
exports.SmartDefaultsService = void 0;
exports.createSmartDefaultsService = createSmartDefaultsService;
/**
...
class SmartDefaultsService {
     ...
     * Get smart defaults
     */
    async getDefaults(factors) {
        // Start with base defaults
        let settings = this.getBaseDefaults();
     ...
     */
    async getDefaultsForType(documentType, factors) {
     ...
     */
    async getDefaultsForAudience(audience, factors) {
        return this.getDefaults({
            ...factors,
            audience
        });
     ...
     */
    async getTemplateRecommendations(format, factors) {
     ...
     * Explain defaults
     */
    async explainDefaults(settings) {
        const explanations = [];
     ...
     * Compare defaults
     */
    async compareDefaults(settings1, settings2) {
        const differences = [];
        const similarities = [];
        // Compare templates
     ...
     * Apply project context
     */
    applyProjectContext(settings, context) {
     ...
     * Apply document type rules
     */
    applyDocumentTypeRules(settings, documentType) {
     ...
     * Apply audience rules
     */
    applyAudienceRules(settings, audience) {
     ...
     * Apply purpose rules
     */
    applyPurposeRules(settings, purpose) {
     ...
     * Calculate metadata
     */
    calculateMetadata(factors, settings) {
     ...
     * Generate rationale
     */
    generateRationale(factors, _settings) {
        const reasons = [];
        if (factors.userPreferences) {
...
exports.SmartDefaultsService = SmartDefaultsService;
/**
 * Create Smart Defaults Service instance
 */
function createSmartDefaultsService() {
    return new SmartDefaultsService();
}
//# sourceMappingURL=SmartDefaultsService.js.map