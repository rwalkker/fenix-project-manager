...
exports.ExcelColorUtils = void 0;
/**
...
class ExcelColorUtils {
     ...
     */
    static createAmazonFill(color, pattern = 'solid') {
        return {
            type: 'pattern',
            pattern: pattern,
     ...
     */
    static createAmazonBorder(color = '#232F3E', style = 'thin') {
        const borderColor = this.getExcelColor(color);
        const borderStyle = { style: style, color: borderColor };
        return {
            top: borderStyle,
            left: borderStyle,
            bottom: borderStyle,
...
exports.ExcelColorUtils = ExcelColorUtils;
//# sourceMappingURL=ExcelColorUtils.js.map