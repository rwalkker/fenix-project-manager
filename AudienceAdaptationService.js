...
exports.AudienceAdaptationService = void 0;
exports.createAudienceAdaptationService = createAudienceAdaptationService;
/**
 * Audience Adaptation Service
 * Adapts content for different audience types
 */
class AudienceAdaptationService {
    audienceProfiles;
    constructor() {
     ...
     */
    async adaptContent(content, audience) {
     ...
     */
    async adaptContentDetailed(content, audience) {
     ...
     * Adjust detail level
     */
    async adjustDetailLevel(content, level) {
     ...
     */
    async recommendAudience(content) {
     ...
     */
    async compareAudiences(audience1, audience2) {
     ...
     */
    adjustDetailLevelInternal(content, level) {
        switch (level) {
            case 'high':
                // Keep all details
                return content;
     ...
     */
    adjustToneInternal(content, tone) {
     ...
     * Adjust technical level
     */
    adjustTechnicalLevel(content, level) {
        switch (level) {
            case 'high':
     ...
     */
    removeExcessiveDetails(content, ratio) {
     ...
     */
    simplifyTechnicalTerms(content, _ratio) {
     ...
     * Check for executive indicators
     */
    hasExecutiveIndicators(content) {
     ...
     * Check for technical indicators
     */
    hasTechnicalIndicators(content) {
...
exports.AudienceAdaptationService = AudienceAdaptationService;
/**
 * Create Audience Adaptation Service instance
 */
function createAudienceAdaptationService() {
    return new AudienceAdaptationService();
}
//# sourceMappingURL=AudienceAdaptationService.js.map