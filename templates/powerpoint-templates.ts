...
import type { PowerPointOptions, SlideDefinition, PowerPointTemplateType } from '../models/powerpoint-types';
import { AMAZON_POWERPOINT_THEME } from '../models/powerpoint-types';

/**
 * Get PowerPoint template by type
 */
export function getPowerPointTemplate(
 ...
 */
export function listPowerPointTemplates(): Array<{
  ...
  return [
    {
      id: 'project-status' as PowerPointTemplateType,
      name: 'Project Status Report',
      description: 'Comprehensive project status with timeline, risks, and metrics',
      slideCount: 8
    },
    {
      id: 'executive-presentation' as PowerPointTemplateType,
...
function getProjectStatusTemplate(data?: Record<string, any>): PowerPointOptions {
...
function getExecutivePresentationTemplate(data?: Record<string, any>): PowerPointOptions {
...
function getTrainingDeckTemplate(data?: Record<string, any>): PowerPointOptions {
...
function getChangeManagementTemplate(data?: Record<string, any>): PowerPointOptions {
...
function getTechnicalReviewTemplate(data?: Record<string, any>): PowerPointOptions {
...
function getQuarterlyReviewTemplate(data?: Record<string, any>): PowerPointOptions {
