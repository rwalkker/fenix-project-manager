...
exports.listWordTemplates = listWordTemplates;
/**
 * Get Word template by type
 */
function getWordTemplate(type, data) {
    switch (type) {
        case 'white-paper':
 ...
 */
function getWhitePaperTemplate(data) {
 ...
 */
function getProjectCharterTemplate(data) {
 ...
 */
function getMeetingMinutesTemplate(data) {
 ...
 */
function getExecutiveSummaryTemplate(data) {
...
//# sourceMappingURL=word-templates.js.map