...
function listAvailableTemplates() {
    ...
    const templates = (0, word_templates_1.listWordTemplates)();
 ...
 */
async function generateDocument(templateType) {
    console.log(`\n📄 Generating Word document: ${templateType}...\n`);
    try {
        // Get sample data based on template type
        const data = getSampleData(templateType);
        // Get template
        const template = (0, word_templates_1.getWordTemplate)(templateType, data);
        // Create agent and generate
        const agent = (0, WordAgent_1.createWordAgent)();
...
async function testAllTemplates() {
    ...
    for (const template of templates) {
        ...
        try {
            ...
            const templateOptions = (0, word_templates_1.getWordTemplate)(template.id, data);
            const agent = (0, WordAgent_1.createWordAgent)();
