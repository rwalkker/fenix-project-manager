...
const AudienceAdaptationService_1 = require("../services/AudienceAdaptationService");
const StyleConsistencyService_1 = require("../services/StyleConsistencyService");
const ContentReuseService_1 = require("../services/ContentReuseService");
const SmartDefaultsService_1 = require("../services/SmartDefaultsService");
/**
...
async function testContextAwareServices() {
    ...
    console.log('-'.repeat(80));
    const userPrefService = new UserPreferenceService_1.UserPreferenceService();
    ...
    console.log('-'.repeat(80));
    const projectService = new ProjectContextService_1.ProjectContextService();
    // Create project
    const project = {
        id: 'proj-001',
    ...
    console.log('-'.repeat(80));
    const audienceService = new AudienceAdaptationService_1.AudienceAdaptationService();
    ...
    for (const audience of audiences) {
        await audienceService.adaptContent(testContent, audience);
        const profile = audienceService.getAudienceProfile(audience);
    ...
    console.log('-'.repeat(80));
    const styleService = new StyleConsistencyService_1.StyleConsistencyService();
    // Get style guides
    ...
    console.log('-'.repeat(80));
    const contentService = new ContentReuseService_1.ContentReuseService();
    // Add content blocks
    const blocks = [
        {
            id: 'block-1',
    ...
    console.log('-'.repeat(80));
    const defaultsService = new SmartDefaultsService_1.SmartDefaultsService();
...
//# sourceMappingURL=test-context-aware.js.map