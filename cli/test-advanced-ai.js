...
const CitationManagementService_1 = require("../services/CitationManagementService");
// Test content
const sampleContent = `
...
async function testDocumentSummarization() {
    ...
    const service = new DocumentSummarizationService_1.DocumentSummarizationService();
...
async function testKeyPointExtraction() {
    ...
    const service = new KeyPointExtractionService_1.KeyPointExtractionService();
...
async function testSentimentAnalysis() {
    ...
    const service = new SentimentAnalysisService_1.SentimentAnalysisService();
    ...
    if (tone.secondary)
        console.log(`   Secondary: ${tone.secondary}`);
...
async function testReadability() {
    ...
    const service = new ReadabilityService_1.ReadabilityService();
...
async function testComplianceChecking() {
    ...
    const service = new ComplianceCheckingService_1.ComplianceCheckingService();
...
async function testCitationManagement() {
    ...
    const service = new CitationManagementService_1.CitationManagementService();
    // Add sources
...
// Run tests
runAllTests();
//# sourceMappingURL=test-advanced-ai.js.map