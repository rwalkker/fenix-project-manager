...
class ReadabilityService {
     ...
     * Simplify content
     */
    async simplifyContent(content, options) {
     ...
     */
    async optimizeForAudience(content, audienceLevel) {
        const targetGrades = {
            'elementary': 5,
            'high-school': 10,
            'college': 14,
    ...
    generateSummary(score, improvementCount) {
        const parts = [];
...
//# sourceMappingURL=ReadabilityService.js.map